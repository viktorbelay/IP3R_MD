...
psf.setBox(12.8, 12.8, 11.6) # Change for different charmm output etc
...
pressure = 1*unit.bar
surface_tension = 200*unit.bar*unit.nanometer
...
sim.reporters.append(
    app.StateDataReporter(
        output_prefix + state_data , # Change to write out to a seperate file (as CSV or something else)
